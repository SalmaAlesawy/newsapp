...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/Home._icn.svg
  SvgGenImage get homeIcn => const SvgGenImage('assets/icons/Home._icn.svg');

  /// File path: assets/icons/arrow_down.svg
  SvgGenImage get arrowDown => const SvgGenImage('assets/icons/arrow_down.svg');

  /// File path: assets/icons/arrow_icn.svg
  SvgGenImage get arrowIcn => const SvgGenImage('assets/icons/arrow_icn.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/DarkSplash.png
  AssetGenImage get darkSplash =>
      const AssetGenImage('assets/images/DarkSplash.png');

  /// File path: assets/images/LightSplash.png
  AssetGenImage get lightSplash =>
      const AssetGenImage('assets/images/LightSplash.png');
